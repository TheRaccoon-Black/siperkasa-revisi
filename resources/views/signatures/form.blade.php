...
<body>
    <div style="display: grid; grid-template-columns: repeat(12, 1fr); gap: 20px; width: 100%;">
        <div class="signature-container">
            ...
            <p><strong>Role:</strong> @php if($role == 'Danru Penerima') echo 'Komandan Jaga Penerima';else if ($role == 'Danru Penyerah') echo 'Komandan Jaga Penyerah';else if ($role == 'Asst Man') echo 'Asst Man';else if ($role == 'Paraf Penyerah') echo 'Danru Penyerah'; @endphp</p>
            <p>Harus diisi Oleh: <strong>{{ $name }}</strong></p>

            @if (isset($isFilled) && $isFilled)
                <p>Tanda tangan sudah diisi oleh : @php if($role == 'Danru Penerima') echo 'Komandan Jaga Penerima';else if ($role == 'Danru Penyerah') echo 'Komandan Jaga Penyerah';else if ($role == 'Asst Man') echo 'Asst Man';else if ($role == 'Paraf Penyerah') echo 'Danru Penyerah'; @endphp .</p>
            @else
